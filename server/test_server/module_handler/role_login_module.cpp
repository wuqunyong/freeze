...
{
	MockRole::addHandler(s_sName, "login", std::bind(&RoleLoginModule::handleLogin, std::placeholders::_1, std::placeholders::_2));
}

void RoleLoginModule::handleLogin(MockRole& mockRole, ::pubsub::TEST_CMD& msg)
{
