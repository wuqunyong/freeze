...
def GenFile(sName, sStruct, sEnum, sConstructor, sProperty) :
    sTemplate = """// ---------------------------------------------------------------------
...
"""
    ...
    sDefine = sTemplate.format(sName, sStruct, sEnum, sConstructor, sProperty, sName, sName)
    return sDefine
...
def main(argc, argv ):
    ...
    for items in dConfig["database"]:
        ...
        for tItem in tSChemaResult:
            ...
            sFile = GenFile(sTable, sStruct, sEnum, sConstructor, sProperty)

            logging.info("lResult:{}".format(lResult))

            sMergeName = sTable + "_AutoGen" + ".h"
