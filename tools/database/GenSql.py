...
def GenFile(sSChema, sName, sStruct, sEnum, sConstructor, sCreate, sProperty, sBindType, sBindSpace) :
    sTemplate = """// ---------------------------------------------------------------------
...
def main(argc, argv ):
    ...
    for items in dConfig["database"]:
        ...
        for tItem in tSChemaResult:
            ...
            sFile = GenFile(sSChema, sTable, sStruct, sEnum, sConstructor, sCreate, sProperty, sBindType, sBindSpace)
