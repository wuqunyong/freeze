...
def GenFile(sSChema, sName, sStruct, sEnum, sConstructor, sProperty, sBindType) :
    sTemplate = """// ---------------------------------------------------------------------
...
"""
    sTimestamp = time.strftime("%Y.%m.%d %H:%M:%S", time.localtime())
    sDefine = sTemplate.format(sSChema, sName, sTimestamp, sSChema, sName, sStruct, sEnum, sConstructor, sProperty, sName, sName, sBindType, sSChema, sName, sName)
    return sDefine
...
def main(argc, argv ):
    ...
    for items in dConfig["database"]:
        ...
        for tItem in tSChemaResult:
            ...
            sFile = GenFile(sSChema, sTable, sStruct, sEnum, sConstructor, sProperty, sBindType)

            logging.info("lResult:{}".format(lResult))

            sCreateDir = sDir + "/dao" + "/" + sSChema
