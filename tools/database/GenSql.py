...
def GenFile(sSChema, sName, sStruct, sEnum, sConstructor, sCreate, sProperty, sBindType) :
    sTemplate = """// ---------------------------------------------------------------------
...
"""
    sDefine = sTemplate.format(sSChema, sName,
                               sSChema,
                               sName, sName,
                               sStruct, sEnum, sConstructor,
                               sCreate, sProperty,
                               sName, sName,
                               sBindType, sSChema, sName, sName)
    return sDefine
...
def main(argc, argv ):
    ...
    for items in dConfig["database"]:
        ...
        for tItem in tSChemaResult:
            ...
            sFile = GenFile(sSChema, sTable, sStruct, sEnum, sConstructor, sCreate, sProperty, sBindType)
