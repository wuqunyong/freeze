...
def GenFile(sSChema, sName, sStruct, sEnum, sConstructor, sProperty) :
    sTemplate = """// ---------------------------------------------------------------------
...
"""
    ...
    sDefine = sTemplate.format(sSChema, sName, sStruct, sEnum, sConstructor, sProperty, sName, sName)
    return sDefine
...
def main(argc, argv ):
    ...
    for items in dConfig["database"]:
        ...
        for tItem in tSChemaResult:
            ...
            sFile = GenFile(sSChema, sTable, sStruct, sEnum, sConstructor, sProperty)
