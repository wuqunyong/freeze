...
PROTOBUF_NAMESPACE_OPEN
template<> ::pb::core::StatusPb* Arena::CreateMaybeMessage<::pb::core::StatusPb>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace pb {
namespace core {
...
class StatusPb final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:pb.core.StatusPb) */ {
 public:
  ...
  ::pb::core::ErrorCode error_code() const;
  void set_error_code(::pb::core::ErrorCode value);
  private:
  ::pb::core::ErrorCode _internal_error_code() const;
  void _internal_set_error_code(::pb::core::ErrorCode value);
  public:

  // @@protoc_insertion_point(class_scope:pb.core.StatusPb)
 private:
  class _Internal;
...
inline ::pb::core::ErrorCode StatusPb::_internal_error_code() const {
  return static_cast< ::pb::core::ErrorCode >(_impl_.error_code_);
}
inline ::pb::core::ErrorCode StatusPb::error_code() const {
  // @@protoc_insertion_point(field_get:pb.core.StatusPb.error_code)
  return _internal_error_code();
}
inline void StatusPb::_internal_set_error_code(::pb::core::ErrorCode value) {
  
  _impl_.error_code_ = value;
}
inline void StatusPb::set_error_code(::pb::core::ErrorCode value) {
  _internal_set_error_code(value);
  // @@protoc_insertion_point(field_set:pb.core.StatusPb.error_code)
}
...
inline const std::string& StatusPb::msg() const {
  // @@protoc_insertion_point(field_get:pb.core.StatusPb.msg)
...
void StatusPb::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:pb.core.StatusPb.msg)
}
inline std::string* StatusPb::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:pb.core.StatusPb.msg)
  return _s;
}
...
inline std::string* StatusPb::release_msg() {
  // @@protoc_insertion_point(field_release:pb.core.StatusPb.msg)
...
inline void StatusPb::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.core.StatusPb.msg)
}
...
template <> struct is_proto_enum< ::pb::core::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::core::ErrorCode>() {
  return ::pb::core::ErrorCode_descriptor();
}
