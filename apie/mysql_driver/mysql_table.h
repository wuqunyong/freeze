...
public:
	...
	bool generateQueryByFilterSQL(MySQLConnector& connector, const ::mysql_proxy_msg::MysqlQueryByFilterRequest& query, std::string& sql);
	bool generateQueryAllSQL(MySQLConnector& connector, const ::mysql_proxy_msg::MysqlQueryAllRequest& query, std::string& sql);
