...
enum OPCODE_ID : int {
  ...
  OPCODE_ID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  OPCODE_ID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool OPCODE_ID_IsValid(int value);
constexpr OPCODE_ID OPCODE_ID_MIN = OP_None;
constexpr OPCODE_ID OPCODE_ID_MAX = OP_MSG_RESPONSE_HEARTBEAT;
...
inline bool OPCODE_ID_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, OPCODE_ID* value) {
